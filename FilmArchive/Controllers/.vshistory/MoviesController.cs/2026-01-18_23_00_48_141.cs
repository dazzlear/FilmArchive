...
namespace FilmArchive.Controllers
{
    public class MoviesController : Controller
    {
        ...
        {
            // IMPORTANT: Remove these from validation so they don't cause ModelState.IsValid to be false
            ...
            // If we reach here, validation failed. Get the specific error to show in the toast.
        ...
        public async Task<IActionResult> Edit(int id, Movie movie, IFormFile? imageFile)
        {
            ...
            {
                // Fetch existing path so it isn't overwritten with null
