    ...
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchTerm, string genre, string category, string sortBy)
        {
            ...
            moviesQuery = sortBy switch
            {
                ...
                "year_newest" => moviesQuery.OrderByDescending(m => m.ReleaseYear), 
                "year_oldest" => moviesQuery.OrderBy(m => m.ReleaseYear),           
                _ => moviesQuery.OrderByDescending(m => m.Id),                      // Default: Most recently added
            };
